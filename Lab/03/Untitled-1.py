...
REDtileset = Image.open("ball-red.png").convert("RGBA")
VIOtileset = Image.open("ball-violet.png").convert("RGBA")
PNKtileset = Image.open("ball-pink.png").convert("RGBA")
GRNtileset = Image.open("ball-green.png").convert("RGBA")
YLWtileset = Image.open("ball-yellow.png").convert("RGBA")
BLUtileset = Image.open("ball-blue.png").convert("RGBA")
AQAtileset = Image.open("ball-aqua.png").convert("RGBA")
